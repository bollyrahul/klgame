...
def main():
    ...
    if n == 1:
        ...
        def ok1():
            ...
            x_a = ["Seal", "Bear", "Snake", "Book", "Kite", "Car", "Tree", "Chair", "Lion", "Elephant"]
            y_a = 0
        ...
        img1 = PhotoImage(file="turtle.png")
        ...
        def ok2():
            ...
            var_a = [var_a1, var_a2, var_a3, var_a4, var_a5, var_a6, var_a7, var_a8, var_a9, var_a10]
            x_a = ["Einstein", "Bear", "Earth", "Book", "Kite", "Car", "Tree", "turtle", "Lion", "Elephant"]
            y_a = 0
            buttons_a = [Checkbutton(root1, text=x_a[i], variable=var_a[i]) for i in range(10)]
            for b in buttons_a:
                b.grid(row=y_a, sticky=W)
        ...
        def ok3():
            ...
            var_a = [var_a1, var_a2, var_a3, var_a4, var_a5, var_a6, var_a7, var_a8, var_a9, var_a10]
            x_a = ["Seal", "Bear", "Laptop", "Book", "Guitar", "Car", "Tree", "Chair", "Lion", "snake"]
            y_a = 0
            buttons_a = [Checkbutton(root1, text=x_a[i], variable=var_a[i]) for i in range(10)]
            for b in buttons_a:
                b.grid(row=y_a, sticky=W)
        ...
        img2 = PhotoImage(file="apple.png")
        ...
        def ok4():
            ...
            var_a = [var_a1, var_a2, var_a3, var_a4, var_a5, var_a6, var_a7, var_a8, var_a9, var_a10]
            x_a = ["apple", "Bear", "snake", "Book", "Table", "Car", "Tree", "Mobile", "Chair", "Elephant"]
            y_a = 0
            buttons_a = [Checkbutton(root1, text=x_a[i], variable=var_a[i]) for i in range(10)]
            for b in buttons_a:
                b.grid(row=y_a, sticky=W)
